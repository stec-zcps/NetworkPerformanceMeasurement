// <copyright file="ThroughputTestParameters.cs" company="Fraunhofer Institute for Manufacturing Engineering and Automation IPA">
...
namespace NetworkPerformanceShared.Model
{
    ...
    /// </summary>
    public class ThroughputTestParameters
    {
        /// <summary>Gets or sets id of the the <see cref="LatencyTestParameters"/>.</summary>
        public long Id { get; set; }

        /// <summary>Gets or sets <see cref="ThroughputTestResult"/> in which these parameters have been used.</summary>
        [ForeignKey("ThroughputTestResultId")]
        public ThroughputTestResult RelatedTestResult { get; set; }
